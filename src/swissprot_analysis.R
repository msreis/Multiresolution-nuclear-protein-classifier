...
for(i in 1:length(iterations)){
  df_swiss_prot_t_cruzi[i, 'query_id'] <- iterations[i]$Iteration$`Iteration_query-def`
  ...
  #df_swiss_prot_t_cruzi[i, 'subject_id'] <- iterations[i]$Iteration$Iteration_hits$`Hit`$Hit_def
